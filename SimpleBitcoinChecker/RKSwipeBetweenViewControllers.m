...
#define HEIGHT 20 //%%% height of the segment
...
- (void)viewDidLoad
{
    ...
    UIColor *tabBarColor = [UIColor midnightBlueColor];
    self.navigationBar.barTintColor = tabBarColor; //%%% bartint
    ...
    UIViewController* theController = [storyboard instantiateViewControllerWithIdentifier:@"CurrentRateViewControllerStoryBoardID"];
    UITableViewController* theController2 = [storyboard instantiateViewControllerWithIdentifier:@"CurrencySelectStoryboardID"];
    UIViewController* theController3 = [storyboard instantiateViewControllerWithIdentifier:@"AccountsStoryboardID"];
    
    [viewControllerArray addObjectsFromArray:@[theController, theController2, theController3]];
}
...
-(void)setupSegmentButtons
{
    ...
    if (!buttonText) {
         buttonText = [[NSArray alloc]initWithObjects: @"Rate",@"Currency",@"Balance",@"fourth",@"etc",@"etc",@"etc",@"etc",nil]; //%%%buttontitle
    }
    ...
    for (int i = 0; i<numControllers; i++) {
        ...
        button.backgroundColor = tabBarColor;//%%% buttoncolors
        
        //button.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:18];
        
        button.titleLabel.font = [UIFont flatFontOfSize:18];
...
-(void)setupSelector
{
    ...
    UIColor *selectionBarColor = [UIColor turquoiseColor];
    
    selectionBar.backgroundColor = selectionBarColor; //%%% sbcolor
    selectionBar.alpha = 0.8; //%%% sbalpha
    [navigationView addSubview:selectionBar];
    
    manualSelectionBar = [[UIView alloc]initWithFrame:selectionBar.frame];
    manualSelectionBar.backgroundColor = selectionBarColor; //%%% sbcolor (moving)
